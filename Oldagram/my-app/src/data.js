...
const data = [
    ...
    },
    {
        ...
        bio: ["📍 Ornans,France","When I am no longer controversial, I will no longer be important"],
        likes: 4,
        following:0,
        followers:1231,
        isLiked:false,
        ...
        post: postDucreux,
        posts: [postDucreux,post2Ducreux,avatarDucreux],
        quote: "gm friends! which coin are YOU stacking up today?? post below and WAGMI!",
        bio: ["🖼👨‍🎨 portrait painter", "🎨pastelist", "🔬miniaturist","🛠engraver"],
        likes: 152,
        following:76,
        followers:4195,
        isLiked:false,
